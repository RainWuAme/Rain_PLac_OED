...
%%
    ...
    newExps.n_s{1}=(i*duration)/timeWindow + 1;
    newExps.t_s{1}=0:timeWindow:(i*duration);
...
for i=1:10
    ...
    inputs.exps.n_s{1}          = duration/timeWindow + 1;          % Number of sampling times
    inputs.exps.t_s{1}          = 0:timeWindow:duration;            % Times of samples
